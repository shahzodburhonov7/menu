...
mixin _$FoodsBuildable {
  ...
  bool get orderLoadingProduct => throw _privateConstructorUsedError;
  ...
  List<VegetablesAll> get vegetablesPro => throw _privateConstructorUsedError;
...
abstract class $FoodsBuildableCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<VegetablesAll> vegetablesPro,
      String type,
      int cartId,
      int cartIdProduct});
...
class _$FoodsBuildableCopyWithImpl<$Res, $Val extends FoodsBuildable>
  ...
  $Res call({
    ...
    Object? orderLoadingProduct = null,
    ...
    return _then(_value.copyWith(
      ...
      orderLoading: null == orderLoading
          ...
          : orderLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      orderLoadingProduct: null == orderLoadingProduct
          ? _value.orderLoadingProduct
          : orderLoadingProduct // ignore: cast_nullable_to_non_nullable
              as bool,
      ...
      vegetablesPro: null == vegetablesPro
          ? _value.vegetablesPro
          : vegetablesPro // ignore: cast_nullable_to_non_nullable
              as List<VegetablesAll>,
      type: null == type
          ? _value.type
...
class _$FoodsBuildableImpl implements _FoodsBuildable {
  const _$FoodsBuildableImpl(
      ...
      this.orderLoadingProduct = false,
      ...
      final List<VegetablesAll> vegetablesPro = const [],
      this.type = "",
      this.cartId = 0,
  ...
  @override
  @JsonKey()
  final bool orderLoadingProduct;
  @override
  @JsonKey()
  ...
  final List<VegetablesAll> _vegetablesPro;
  @override
  @JsonKey()
  List<VegetablesAll> get vegetablesPro {
    if (_vegetablesPro is EqualUnmodifiableListView) return _vegetablesPro;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_vegetablesPro);
  }
  ...
  @override
  String toString() {
    return 'FoodsBuildable(loading: $loading, loadingVegetables: $loadingVegetables, proLoading: $proLoading, pageLoading: $pageLoading, orderLoading: $orderLoading, orderLoadingProduct: $orderLoadingProduct, vegetablesOrder: $vegetablesOrder, vegetablesOrderPro: $vegetablesOrderPro, postCreate: $postCreate, orderCount: $orderCount, pageType: $pageType, foodCategoryList: $foodCategoryList, vegetablesAll: $vegetablesAll, tableNumber: $tableNumber, tableOrder: $tableOrder, tableOrderProduct: $tableOrderProduct, getTableList: $getTableList, foodPro: $foodPro, vegetablesPro: $vegetablesPro, type: $type, cartId: $cartId, cartIdProduct: $cartIdProduct)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.orderLoadingProduct, orderLoadingProduct) ||
                other.orderLoadingProduct == orderLoadingProduct) &&
            ...
            const DeepCollectionEquality()
                .equals(other._vegetablesPro, _vegetablesPro) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(_vegetablesPro),
        type,
        cartId,
        cartIdProduct
      ]);
...
abstract class _FoodsBuildable implements FoodsBuildable {
  const factory _FoodsBuildable(
      ...
      final List<VegetablesAll> vegetablesPro,
      final String type,
      final int cartId,
      final int cartIdProduct}) = _$FoodsBuildableImpl;
