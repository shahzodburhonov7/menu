...
class _$FoodsBuildableImpl implements _FoodsBuildable {
  ...
  @override
  String toString() {
    return 'FoodsBuildable(loading: $loading, proLoading: $proLoading, pageLoading: $pageLoading, orderLoading: $orderLoading, orderCount: $orderCount, pageType: $pageType, foodCategoryList: $foodCategoryList, foodPro: $foodPro, type: $type)';
  }
