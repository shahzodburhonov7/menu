...
OrdersDoneList _$OrdersDoneListFromJson(Map<String, dynamic> json) {
  return _OrdersDoneList.fromJson(json);
}

/// @nodoc
mixin _$OrdersDoneList {
...
/// @nodoc
abstract class $OrdersDoneListCopyWith<$Res> {
  factory $OrdersDoneListCopyWith(
          OrdersDoneList value, $Res Function(OrdersDoneList) then) =
      _$OrdersDoneListCopyWithImpl<$Res, OrdersDoneList>;
  @useResult
  $Res call(
      {int? id,
      Cart? cart,
...
/// @nodoc
class _$OrdersDoneListCopyWithImpl<$Res, $Val extends OrdersDoneList>
    implements $OrdersDoneListCopyWith<$Res> {
  _$OrdersDoneListCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OrdersDoneListImplCopyWith<$Res>
    implements $OrdersDoneListCopyWith<$Res> {
  factory _$$OrdersDoneListImplCopyWith(_$OrdersDoneListImpl value,
          $Res Function(_$OrdersDoneListImpl) then) =
      __$$OrdersDoneListImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$OrdersDoneListImplCopyWithImpl<$Res>
    extends _$OrdersDoneListCopyWithImpl<$Res, _$OrdersDoneListImpl>
    implements _$$OrdersDoneListImplCopyWith<$Res> {
  __$$OrdersDoneListImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$OrdersDoneListImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$OrdersDoneListImpl implements _OrdersDoneList {
  const _$OrdersDoneListImpl(
      {this.id, this.cart, this.status, this.created_at, this.total_price});

  factory _$OrdersDoneListImpl.fromJson(Map<String, dynamic> json) =>
      _$$OrdersDoneListImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OrdersDoneList(id: $id, cart: $cart, status: $status, created_at: $created_at, total_price: $total_price)';
  }
  ...
  _$$OrdersDoneListImplCopyWith<_$OrdersDoneListImpl> get copyWith =>
      __$$OrdersDoneListImplCopyWithImpl<_$OrdersDoneListImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OrdersDoneListImplToJson(
      this,
    );
  }
}

abstract class _OrdersDoneList implements OrdersDoneList {
  const factory _OrdersDoneList(
      {final int? id,
      final Cart? cart,
      final String? status,
      final DateTime? created_at,
      final String? total_price}) = _$OrdersDoneListImpl;

  factory _OrdersDoneList.fromJson(Map<String, dynamic> json) =
      _$OrdersDoneListImpl.fromJson;
