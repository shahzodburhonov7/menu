...
_$FoodInfoImpl _$$FoodInfoImplFromJson(Map<String, dynamic> json) =>
    _$FoodInfoImpl(
      ...
      food_composition_uz: json['food_composition_uz'] as String?,
      food_composition_ru: json['food_composition_ru'] as String?,
      food_composition_en: json['food_composition_en'] as String?,
    );
...
Map<String, dynamic> _$$FoodInfoImplToJson(_$FoodInfoImpl instance) =>
    <String, dynamic>{
      ...
      'food_composition_uz': instance.food_composition_uz,
      'food_composition_ru': instance.food_composition_ru,
      'food_composition_en': instance.food_composition_en,
    };
