...
abstract class $ProfileCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? first_name, String? last_name, dynamic profile_image});
}
...
class _$ProfileImpl implements _Profile {
  const _$ProfileImpl({this.first_name, this.last_name, this.profile_image});
  ...
  @override
  String toString() {
    return 'Profile(first_name: $first_name, last_name: $last_name, profile_image: $profile_image)';
  }
...
abstract class _Profile implements Profile {
  const factory _Profile(
      {final String? first_name,
      final String? last_name,
      final dynamic profile_image}) = _$ProfileImpl;
