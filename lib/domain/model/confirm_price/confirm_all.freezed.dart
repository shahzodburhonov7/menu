...
ConfirmAll _$ConfirmAllFromJson(Map<String, dynamic> json) {
  return _ConfirmAll.fromJson(json);
}
...
mixin _$ConfirmAll {
  ...
  @JsonKey(ignore: true)
  $ConfirmAllCopyWith<ConfirmAll> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ConfirmAllCopyWith<$Res> {
  factory $ConfirmAllCopyWith(
          ConfirmAll value, $Res Function(ConfirmAll) then) =
      _$ConfirmAllCopyWithImpl<$Res, ConfirmAll>;
  @useResult
  $Res call(
      {int? id,
      Cart? cart,
...
/// @nodoc
class _$ConfirmAllCopyWithImpl<$Res, $Val extends ConfirmAll>
    implements $ConfirmAllCopyWith<$Res> {
  _$ConfirmAllCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ConfirmAllImplCopyWith<$Res>
    implements $ConfirmAllCopyWith<$Res> {
  factory _$$ConfirmAllImplCopyWith(
          _$ConfirmAllImpl value, $Res Function(_$ConfirmAllImpl) then) =
      __$$ConfirmAllImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$ConfirmAllImplCopyWithImpl<$Res>
    extends _$ConfirmAllCopyWithImpl<$Res, _$ConfirmAllImpl>
    implements _$$ConfirmAllImplCopyWith<$Res> {
  __$$ConfirmAllImplCopyWithImpl(
      _$ConfirmAllImpl _value, $Res Function(_$ConfirmAllImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$ConfirmAllImpl implements _ConfirmAll {
  const _$ConfirmAllImpl(
      {this.id,
      this.cart,
      this.date,
      this.time,
  ...
  factory _$ConfirmAllImpl.fromJson(Map<String, dynamic> json) =>
      _$$ConfirmAllImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ConfirmAll(id: $id, cart: $cart, date: $date, time: $time, total_price: $total_price, user_type: $user_type, user_full_name: $user_full_name)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ConfirmAllImplCopyWith<_$ConfirmAllImpl> get copyWith =>
      __$$ConfirmAllImplCopyWithImpl<_$ConfirmAllImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ConfirmAllImplToJson(
      this,
    );
  }
}

abstract class _ConfirmAll implements ConfirmAll {
  const factory _ConfirmAll(
      {final int? id,
      final Cart? cart,
      final DateTime? date,
      final String? time,
      final int? total_price,
      final String? user_type,
      final String? user_full_name}) = _$ConfirmAllImpl;

  factory _ConfirmAll.fromJson(Map<String, dynamic> json) =
      _$ConfirmAllImpl.fromJson;
